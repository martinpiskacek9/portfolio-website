...
const HeroSlider = ({ heading, link, onNext, onPrev }) => {
  return (
    <div className="w-full flex items-center justify-between absolute left-1/2 -translate-x-1/2 bottom-0 p-8">
      ...
      <a className="font-raleway font-normal text-xl uppercase motion-preset-fade motion-delay-300 motion-duration-1500 motion-preset-slide-right tracking-widest"href={link}>{heading}</a>
