...
const GalleryCategory = ({ heading, img }) => {
  return (
    <div className="w-full md:w-80 xl:w-70 h-90 overflow-hidden hover:outline outline-neutral-400">
      ...
      >
        <a href="#" className="font-montserrat w-full h-full flex items-center justify-center md:opacity-0 opacity-100 text-2xl md:text-xl uppercase font-bold hover:opacity-100 bg-black/50 hover:bg-black/80 hover:text-neutral-50 hover:scale-95 duration-300"
        >
          {heading}
        </a>
      </div>
