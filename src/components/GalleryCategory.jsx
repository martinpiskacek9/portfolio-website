...
const GalleryCategory = ({ heading, img, className = "" }) => {
  return (
    <div className={`h-90 overflow-hidden hover:outline outline-neutral-400 ${className}`}>
      ...
      >
        <NavLink to="#" className="font-montserrat w-full h-full flex items-center justify-center md:opacity-0 opacity-100 text-2xl md:text-xl uppercase font-bold hover:opacity-100 bg-black/50 hover:bg-black/80 hover:text-neutral-50 duration-300"
        >
          {heading}
        </NavLink>
      </div>
